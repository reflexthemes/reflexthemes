 ...
 */
function reflex_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'reflex_content_width', 1200 );
}
add_action( 'after_setup_theme', 'reflex_content_width', 0 );
 ...
 * ------------------------------------------------------------------------------------------------
 */
if( ! function_exists( 'reflex_theme_setup' ) ) {
	function reflex_theme_setup() {
		...
		register_nav_menus( array(
			'menu-1' 		=> esc_html__( 'Primary', 'reflex' ),
			'main-menu' 	=> esc_html__( 'Main Menu', 'reflex' ),
			'mobile-menu' 	=> esc_html__( 'Mobile Side Menu', 'reflex' ),
		) );
	...
	add_action( 'after_setup_theme', 'reflex_theme_setup' );
}
...
function reflex_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar', 'reflex' ),
			'id'            => 'sidebar-1',
			'description'   => esc_html__( 'Add widgets here.', 'reflex' ),
